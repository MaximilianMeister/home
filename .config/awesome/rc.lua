...
-- beautiful init
beautiful.init("/usr/share/awesome/themes/holo/theme.lua")

-- common
modkey     = "Mod4"
altkey     = "Mod1"
terminal   = "gnome-terminal" or "urxvt"
...
-- Screen 2
tags[2] = awful.tag( { " CHROME " }, 2, { layouts[6] } )
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Shift", "Control" }, "k",  awful.tag.viewprev       ),
    awful.key({ "Shift", "Control" }, "j",  awful.tag.viewnext       ),
    ...
    -- move focus
    awful.key({ "Control", "Shift" }, "Up", function () awful.client.focus.bydirection("up") end),
    awful.key({ "Control", "Shift" }, "Down", function () awful.client.focus.bydirection("down") end),
    awful.key({ "Control", "Shift" }, "Left", function () awful.client.focus.bydirection("left") end),
    awful.key({ "Control", "Shift" }, "Right", function () awful.client.focus.bydirection("right") end),

    -- swap windows
    awful.key({ "Control", "Shift", altkey }, "Up", function () awful.client.swap.bydirection("up") end),
    awful.key({ "Control", "Shift" , altkey}, "Down", function () awful.client.swap.bydirection("down") end),
    awful.key({ "Control", "Shift" , altkey}, "Left", function () awful.client.swap.bydirection("left") end),
    awful.key({ "Control", "Shift" , altkey}, "Right", function () awful.client.swap.bydirection("right") end),

    -- move client to other screen
    awful.key({ "Control", "Shift", altkey }, "[", function () awful.client.movetoscreen(c, 1) end),
    awful.key({ "Control", "Shift", altkey }, "]", function () awful.client.movetoscreen(c, 2) end),
